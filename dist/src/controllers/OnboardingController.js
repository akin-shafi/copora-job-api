...
var OnboardingController = /** @class */ (function () {
    ...
    OnboardingController.prototype.startOnboarding = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.applicationService.createApplication()];
                    case 1:
                        application = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        res.status(500).send({ message: 'Error starting onboarding process', error: error_1 });
                        return [3 /*break*/, 3];
