...
node_cron_1.default.schedule('0 */11 * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
    var users, _i, users_1, user, emailData, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 8, , 9]);
                return [4 /*yield*/, userService.findUsersWithIncompleteOnboarding()];
            case 1:
                users = _a.sent();
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, emailActions_1.sendOnboardingReminderEmail)(emailData)];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
            ...
            case 8:
                error_1 = _a.sent();
                console.error('Error running the onboarding reminder script:', error_1);
                return [3 /*break*/, 9];
