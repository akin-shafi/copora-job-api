...
const RemindersController_1 = __importDefault(require("../controllers/RemindersController"));
 ...
 */
router.post('/onboarding', RemindersController_1.default.sendOnboardingReminder);
