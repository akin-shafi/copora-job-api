...
var professionalDetailsRepository = data_source_1.AppDataSource.getRepository(ProfessionalDetailsEntity_1.ProfessionalDetails);
var ProfessionalDetailsService = /** @class */ (function () {
    ...
    ProfessionalDetailsService.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        entry = professionalDetailsRepository.create(data);
    ...
    ProfessionalDetailsService.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, professionalDetailsRepository.find()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ProfessionalDetailsService.getByApplicationNo = function (applicationNo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, professionalDetailsRepository.findOneBy({ applicationNo: applicationNo })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ProfessionalDetailsService.updateByApplicationNo = function (applicationNo, data) {
        return __awaiter(this, void 0, void 0, function () {
            var entry;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProfessionalDetailsService.deleteByApplicationNo = function (applicationNo) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, professionalDetailsRepository.delete({ applicationNo: applicationNo })];
                    case 1:
                        result = _a.sent();
                        if (result.affected === 0) {
                            throw new Error('Professional details not found');
                        }
                        return [2 /*return*/, 'Professional details deleted'];
                }
            });
        });
    };
